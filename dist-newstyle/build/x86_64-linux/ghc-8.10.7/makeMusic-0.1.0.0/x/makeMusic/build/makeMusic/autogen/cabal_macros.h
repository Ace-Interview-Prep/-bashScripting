...
/* package makeMusic-0.1.0.0 */
#ifndef VERSION_makeMusic
#define VERSION_makeMusic "0.1.0.0"
#endif /* VERSION_makeMusic */
#ifndef MIN_VERSION_makeMusic
#define MIN_VERSION_makeMusic(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_makeMusic */
...
#define CURRENT_COMPONENT_ID "makeMusic-0.1.0.0-inplace-makeMusic"
